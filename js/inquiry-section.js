...
(function () {
  ...
  const ADDONS = [
    ...
    { id: "custom-template", name: "Custom Photo Design ", price: 100, desc: "We design a one-of-a-kind photo strip layout around your event—your colors, fonts, graphics, and details. Two rounds of revisions included. This is what your guests take home" },
    ...
    { id: "prints-new-w4mh", name: "Magnetic Photo Sleeves", price: 40, desc: "Clear, protective magnetic sleeves that turn every print into a fridge-ready keepsake. Guests slide their photo strip or postcard print inside and it's instantly display-ready — no tape, no pins, no frames needed. One of those small touches that makes the night stick around long after the last photo" },
...
<section class="section inquiry" id="inquiry">
  <div class="container container--narrow">
    ...
    <form class="form form--stepped reveal" data-inquiry-form autocomplete="on" novalidate>

      <!-- Stepper progress header (4 steps) -->
      <ol class="stepper" data-stepper aria-label="Form progress">
        <li class="stepper__item is-active" data-step-dot="1"><span class="stepper__num">1</span><span class="stepper__label">Contact</span></li>
        <li class="stepper__item" data-step-dot="2"><span class="stepper__num">2</span><span class="stepper__label">Event</span></li>
        <li class="stepper__item" data-step-dot="3"><span class="stepper__num">3</span><span class="stepper__label">Package</span></li>
        <li class="stepper__item" data-step-dot="4"><span class="stepper__num">4</span><span class="stepper__label">Details</span></li>
      </ol>
      ...
      <fieldset class="form-step" data-step="3" hidden>
        <div class="form__row form__row--2">
          ...
          <div class="form__field">
            ...
            <select class="form__select" id="packageInterest" name="packageInterest" required>
              <option value="">Select one…</option>
              ${packageOptions}
